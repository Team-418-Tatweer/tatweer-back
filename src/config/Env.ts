...
/**
 * @description The domain name of the platform. If 'DOMAIN' is not set, it defaults to 'microclub.info'
 * @default "microclub.info"
 *
 */
export const DOMAIN = CheckEnv('DOMAIN', 'platforms.microclub.info')

/**
 * @description The URL of the backend. If 'BACK_URL' is not set, it defaults to 'http://localhost:PORT' in development mode and 'https://platforms.microclub.info' in production mode.
...
export const PROJECT_Name = CheckEnv('PROJECT_Name', 'Vinos project')
